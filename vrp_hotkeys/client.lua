...
function vRPhk.lockVehicle(lockStatus, vehicle)
	if lockStatus == 1 or lockStatus == 0 then -- locked or unlocked
		...
		-- ## Notifications
			...
			vRP.notifyPicture({"CHAR_LIFEINVADER", 3, "LockSystem", "vRP Hotkeys", "Veículo trancado."})
		-- ## Notifications
	...
	elseif lockStatus == 2 then -- if it is locked
		...
		-- ## Notifications
			...
			vRP.notifyPicture({"CHAR_LIFEINVADER", 3, "LockSystem", "vRP Hotkeys", "Veículo destrancado."})
		-- ## Notifications
